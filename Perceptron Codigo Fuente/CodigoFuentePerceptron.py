...
import random, math
# //Indice:
# Codigo traducido(de C# a Python3) por: Nahum Gamaliel Santana

# Descripcion:
"""Es una version traducida de C# a Python3. Crea un perceptron simple, capaz
de aprender patrones no lineales."""

# Inspirado por: Hector Pulido(Youtuber)

# Link del video:
"""https://www.youtube.com/watch?
v=xSjlvulOiQY&lc=z12hvvpgnu2ayv
cui23cvz5gtq33sp3h504.150127857
4756087"""
# \\
...
for x in range(Age):
    ...
    print("\n>> Etapa: "+str(x+1))
    print("Entrada '1,1': "+str(Nweb.Output((1,1)))+"/"+str(Exit[0])+"; Objetivo: "+str(Redon(Nweb.Output((1,1)))))
    print("Entrada '1,0': "+str(Nweb.Output((1,0)))+"/"+str(Exit[1])+"; Objetivo: "+str(Redon(Nweb.Output((1,0)))))
    print("Entrada '0,1': "+str(Nweb.Output((0,1)))+"/"+str(Exit[2])+"; Objetivo: "+str(Redon(Nweb.Output((0,1)))))
    print("Entrada '0,0': "+str(Nweb.Output((0,0)))+"/"+str(Exit[3])+"; Objetivo: "+str(Redon(Nweb.Output((0,0)))))
    ...
    if Var != False: # Si no hubo error: Para el aprendizaje.
        ...
        break;
#\\
#LINK DEL CODIGO: https://rextester.com/SSCOP31655
#EN LA PAGINA DEL CODIGO SE PUEDE VER EL FUNCIONAMIENTO 